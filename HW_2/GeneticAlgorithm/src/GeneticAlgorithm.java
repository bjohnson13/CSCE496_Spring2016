...
public class GeneticAlgorithm
{
    public static void main(String[] args)
    {
        ...
        int[][] initialGeneration        = new int[popultionSize * 2][lengthOfWordToMatch]; // row, column
        ...
        // Choose to run random generation algorithm: 1-yes, else-no
        int RANDOM_GENERATIONS = 1;
        int EXPERIMENTING_ALGORITHMS = 2;
        // ============================================
        // ============================================
